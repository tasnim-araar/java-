...
public class Level1 {
    ...
    public static void main(String[] args) {
         ...
         */
        teachers.stream().filter(teacher -> teacher.getSubject() == models.Subject.JAVA).distinct().sorted(Comparator.comparingInt(Teacher::getSalary)).forEach(System.out::println);
